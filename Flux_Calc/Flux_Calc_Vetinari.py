...
Extracted_Path="/Volumes/xray/anthony/expansion_backup/"
print(sys.version)
...
def Flux_Calc(obsid):
    ...
    with rt.new_pfiles_environment(ardlib=True):
        with new_tmpdir() as tmpdir:
            ...
            Evt2_Fpath_L = glob.glob("/Volumes/xray/anthony/expansion_backup/ObsIDs/" + obsid + "/new/*_evt2.fit*")
            ...
            for i in range(0,num):
                ...
                Infile_Str="/Volumes/xray/anthony/expansion_backup/ObsIDs/" + str(obsid) + "/new/" + str(name)
