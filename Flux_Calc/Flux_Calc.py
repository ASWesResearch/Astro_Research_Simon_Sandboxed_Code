...
def Flux_Calc(obsid):
    ...
    with rt.new_pfiles_environment(ardlib=True):
        with new_tmpdir() as tmpdir:
            ...
            print(name)
            Hybrid_Filepath=Root_Path+"xray/anthony/Research_Git/Nearest_Raytraced_Neighbor_Calc/Hybrid_Regions/"+str(obsid)+"/"+str(obsid)+"_Nearest_Neighbor_Hybrid.reg"
            ...
            Hybrid_BG_Filepath=Root_Path+"xray/anthony/Research_Git/Nearest_Raytraced_Neighbor_Calc/Hybrid_Regions/"+str(obsid)+"/"+str(obsid)+"_Nearest_Neighbor_Hybrid_Background.reg"
