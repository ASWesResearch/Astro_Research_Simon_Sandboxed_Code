...
#Reg_Path="/Volumes/xray/anthony/expansion_backup/Hybrid_Regions/"
Reg_Path=Root_Path+"xray/anthony/expansion_backup/Hybrid_Regions/"
...
Extracted_Path=Root_Path+"xray/anthony/expansion_backup/"
print(sys.version)
...
def Flux_Calc(obsid):
    ...
    #Error_Path="/Volumes/xray/anthony/Simon_Sandboxed_Code/Flux_Calc/Source_Fluxes/"+str(obsid)+"/Flux_Calc_Error_Log.txt"
    Error_Path=Root_Path+"xray/anthony/Simon_Sandboxed_Code/Flux_Calc/Source_Fluxes/"+str(obsid)+"/Flux_Calc_Error_Log.txt" #Real Path
    #Error_Path=Root_Path+"xray/anthony/Simon_Sandboxed_Code/Flux_Calc/Source_Fluxes_Test/"+str(obsid)+"/Flux_Calc_Error_Log.txt" #Test Path
    ...
    with rt.new_pfiles_environment(ardlib=True):
        with new_tmpdir() as tmpdir:
            ...
            Evt2_Fpath_L = glob.glob(Root_Path+"xray/anthony/expansion_backup/ObsIDs/" + obsid + "/new/*_evt2.fit*")
            ...
            for i in range(0,num):
                ...
                Infile_Str=Root_Path+"xray/anthony/expansion_backup/ObsIDs/" + str(obsid) + "/new/" + str(name)
                ...
                tic = time.time()
                try:
                    #srcflux(infile=Infile_Str, pos=Pos_Str, outroot=Outroot_Str_Test, bands=Bands_Str, srcreg=Hybrid_Region_Str_Reduced, bkgreg=Hybrid_BG_Region, psfmethod="ideal", rmffile=Rmffile_Str, arffile=Arffile_Str, clobber="no", tmpdir=tmpdir, verbose=5)
                    ...
                    #srcflux(infile=Infile_Str, pos=Pos_Str, outroot=Outroot_Str_Test, bands=Bands_Str, srcreg=Hybrid_Region_Str_Reduced, bkgreg=Bkgfile_Str_Overlap, psfmethod="ideal", rmffile=Rmffile_Str, arffile=Arffile_Str, clobber="no", tmpdir=tmpdir, verbose=5)
                    srcflux(infile=Infile_Str, pos=Pos_Str, outroot=Outroot_Str, bands=Bands_Str, srcreg=Hybrid_Region_Str_Reduced, bkgreg=Bkgfile_Str_Overlap, psfmethod="ideal", rmffile=Rmffile_Str, arffile=Arffile_Str, clobber="no", tmpdir=tmpdir, verbose=5)
